    ...
    <div id="container">
        ...
        <section>
           ...
           <main>
                ...
                <div class="uye_islem">
                    <form action="kisialtiyorum.asp" method="POST">
                       <img width="70%" height="400px" src="resimler/kisi6.jpg" alt="" >
                        <div>
...
Baglantim.Open("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.MapPath("moon.mdb"))
                ...
                sql="select * from kisi_kayit where id=8"
...
Baglantim.Open("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.MapPath("moon.mdb"))
                Set Tablom = server. CreateObject("ADODB.Recordset")
                Tablom.Open "kisi6_yorum",Baglantim,1,3
  %>
