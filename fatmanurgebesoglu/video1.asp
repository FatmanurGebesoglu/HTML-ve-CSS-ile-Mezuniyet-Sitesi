...
<body>
    ...
    <div id="container">
        ...
        <section>
           ...
           <main>
                <h1>Üniversite Tanıtım</h1>
                <div class="uye_islem">
                    <form action="videobiryorum.asp" method="POST">
                       <iframe width="100%" height="400px" src="https://www.youtube.com/embed/7CcZ5IsGzpM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        <div>
...
Baglantim.Open("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.MapPath("moon.mdb"))
                ...
                Tablom.Open "video1_yorum",Baglantim,1,3
  %>
