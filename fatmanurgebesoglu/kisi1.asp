...
<body>
    ...
    <div id="container">
        ...
        <section>
            ...
            <main>
                <h1>Fatmanur Gebeşoğlu</h1>
                <div class="uye_islem">
                    <form action="kisibiryorum.asp" method="POST">
                        <img width="70%" height="400px" src="resimler/kisi1.jpg" alt="">
                        <div>
...
Baglantim.Open("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.MapPath("moon.mdb"))
                ...
                sql="select * from kisi_kayit where id=3"
...
Baglantim.Open("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.MapPath("moon.mdb"))
                Set Tablom = server. CreateObject("ADODB.Recordset")
                Tablom.Open "kisi1_yorum",Baglantim,1,3
  %>
