    ...
    <div id="container">
        ...
        <section>
           ...
           <main>
                <h1>Ali Türk</h1>
                <div class="uye_islem">
                    <form action="kisiucyorum.asp" method="POST">
                       <img width="70%" height="400px" src="resimler/kisi3.jpeg" alt="" >
                        <div>
...
Baglantim.Open("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.MapPath("moon.mdb"))
                ...
                sql="select * from kisi_kayit where id=6"
...
Baglantim.Open("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.MapPath("moon.mdb"))
                Set Tablom = server. CreateObject("ADODB.Recordset")
                Tablom.Open "kisi3_yorum",Baglantim,1,3
  %>
