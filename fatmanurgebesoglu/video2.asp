    ...
    <div id="container">
        ...
        <section>
           ...
           <main>
                <h1>Mezuniyet</h1>
                <div class="uye_islem">
                    <form action="videoikiyorum.asp" method="POST">
                       <iframe width="100%" height="400px" src="https://www.youtube.com/embed/8rY5CaCBc_g" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        <div>
