    ...
    <div id="container">
        ...
        <section>
           ...
           <main>
                <h1>Büşra Kartal</h1>
                <div class="uye_islem">
                    <form action="kisidortyorum.asp" method="POST">
                       <img width="70%" height="400px" src="resimler/kisi4.jpg" alt="" >
                        <div>
...
Baglantim.Open("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.MapPath("moon.mdb"))
                ...
                sql="select * from kisi_kayit where id=5"
...
Baglantim.Open("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.MapPath("moon.mdb"))
                Set Tablom = server. CreateObject("ADODB.Recordset")
                Tablom.Open "kisi4_yorum",Baglantim,1,3
  %>
