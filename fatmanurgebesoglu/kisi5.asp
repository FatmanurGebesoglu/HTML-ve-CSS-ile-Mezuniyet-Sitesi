    ...
    <div id="container">
        ...
        <section>
           ...
           <main>
                <h1>Mehmet Yılmaz</h1>
                <div class="uye_islem">
                    <form action="kisibesyorum.asp" method="POST">
                       <img width="70%" height="400px" src="resimler/kisi5.jpg" alt="" >
                        <div>
...
Baglantim.Open("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.MapPath("moon.mdb"))
                ...
                sql="select * from kisi_kayit where id=7"
...
Baglantim.Open("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.MapPath("moon.mdb"))
                Set Tablom = server. CreateObject("ADODB.Recordset")
                Tablom.Open "kisi5_yorum",Baglantim,1,3
  %>
