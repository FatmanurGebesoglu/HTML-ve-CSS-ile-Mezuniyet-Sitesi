...
Baglantim.Open("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.MapPath("moon.mdb"))
                ...
                Tablom.Open "kisi_kayit",Baglantim
  %>
               <table class="uye_yorumları" style="border: 1px solid black; border-collapse:collapse; width:90%; margin-bottom: 20px; margin-top: 20px;"border="1">
                   <tr>
                       ...
                       <td>ISIM</td>
                       <td>SOYISIM</td>
                       <td>MEZUN OLDUGU BOLUM</td>
                       <td>MEZUNIYET YILI</td>
                       <td>SEHIR</td>
                       <td>LINKEDIN</td>
                       <td>WEB SAYFASI</td>
                       <td>CEP TELEFONU</td>
                   ...
                   response.write "<tr>"
                       ...
                       response.write "<td>" & Tablom("sehir") & "</td>"
                       response.write "<td>" & Tablom("sosyalmedya") & "</td>"
                       response.write "<td>" & Tablom("web_adres") & "</td>"
                       response.write "<td>" & Tablom("cep_no") & "</td>"
