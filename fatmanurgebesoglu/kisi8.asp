    ...
    <div id="container">
        ...
        <section>
            ...
            <main>
                <h1>Zeynep Aydın</h1>
                <div class="uye_islem">
                    <form action="kisisekizyorum.asp" method="POST">
                        <img width="70%" height="400px" src="resimler/kisi8.jpg" alt="">
                        <div>
...
Baglantim.Open("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.MapPath("moon.mdb"))
                ...
                sql="select * from kisi_kayit where id=10"
...
Baglantim.Open("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.MapPath("moon.mdb"))
                Set Tablom = server. CreateObject("ADODB.Recordset")
                Tablom.Open "kisi8_yorum",Baglantim,1,3
  %>
