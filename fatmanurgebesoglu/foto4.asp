...
<body>
    ...
    <div id="container">
        ...
        <section>
           ...
           <main>
                <h1>Fotoğraf Detay</h1>
                <div class="uye_islem">
                    <form action="fotodortyorum.asp" method="POST">
                       <img width="70%" height="400px" src="resimler/foto4.jpg" alt="" >
                        <div>
...
Baglantim.Open("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.MapPath("moon.mdb"))
                ...
                Tablom.Open "foto4_yorum",Baglantim,1,3
  %>
